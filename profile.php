...
<body>
    <div class="container">
        <h3 class="text-center text-white heding-all" style="font-family:
                'Acme', sans-serif;">Student <span class="text-warning">Profile</span></h3>
                ...
                <div class="col-12">
                    <div class="card bg-light">
                        <div class="card-body">
                            ...
                            <div class="card-title text-center m-auto py-5
                                    my-4">
